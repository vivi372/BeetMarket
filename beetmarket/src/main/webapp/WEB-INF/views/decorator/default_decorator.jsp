    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
			 ...
			 <img class="sidebar-card-illustration mb-2" src="/img/Untitled-2.svg" alt="..." 
            ...
            <hr class="sidebar-divider my-0">
              ...
              <!-- 쇼핑 -->
            <li class="nav-item">
                <a class="nav-link shopping" href="#" data-toggle="collapse" data-target="#shopping"
                    aria-expanded="true" aria-controls="shopping">
                    <span>쇼핑</span>
                </a>
                <div id="shopping" class="collapse" aria-labelledby="shopping"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/board/list.do">Borders</a>
            ...
            <!-- 이벤트 -->
            <li class="nav-item">
                <a class="nav-link event" href="/board/list.do">
                    <span>이벤트</span></a>
            </li>
		  ...
		  <hr class="sidebar-divider my-0">
            ...
            <!-- 공지사항  -->
            <li class="nav-item">
                <a class="nav-link notice" href="/board/list.do">
                    <span>공지사항</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<!-- 회원가입  -->
                        ...
                        <li ${(uri == '/member/loginForm.do')?"class='nav-item dropdown no-arrow'":"class='nav-item'"}>
