...
<script type="text/javascript">
	...
	$(function() {	
		...
		$(".refundBtn").click(function() {
			let pointShopOrderNo = $(this).closest(".orderData").find(".pointShopOrderNo").text();
			
			location = "refund.do?pointShopOrderNo="+pointShopOrderNo+
		...
		<tbody>
			<c:forEach items="${list }" var="vo">
				<tr class="orderData">
					...
					<td>
						<!-- 해당 상품의 카테고리가 쿠폰이면 환불 버튼이 생긴다. -->
						<c:if test="${vo.category=='쿠폰'}">
							<button class="btn btn-dark btn-sm refundBtn">환불</button>
						</c:if>
					</td>									
				</tr>
