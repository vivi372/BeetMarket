			  		...
			  		<li class="list-group-item orderListItem" data-goodsNo="${vo.goodsNo }" data-orderNo="${vo.orderNo }" data-categoryNo="${vo.categoryNo }">
						...
						<div class="text-center orderNo" data-orderno="${vo.orderNo }" data-goodsno="${vo.goodsNo }">								
							<c:if test="${vo.orderState == '결제완료' || vo.orderState == '배송준비'}">	
								<button type="button" class="btn btn-outline-warning">취소요청</button>
							</c:if>
							<c:if test="${vo.orderState == '배송중' || vo.orderState == '배송준비'}">	
								<button type="button" class="btn btn-outline-dark">구매확정</button>
								<button type="button" class="btn btn-outline-warning">반품요청</button>
							</c:if>
