...
public class GoodsSearchVO {
	...
	public String getQuery() throws Exception {
		return "cateHighNo=" + toStr(cateHighNo)
				+ "&cateMidNo=" + toStr(cateMidNo)
				+ "&cateLowNo=" + toStr(cateLowNo)
				+ "&goodsName=" 
				+ URLEncoder.encode(toStr(goodsName), "utf-8");
	}
	...
	public Boolean isExist() {
		if(cateHighNo != null && cateHighNo != 0) return true;
		if(!(goodsName == null || goodsName == "")) return true;
		return false;
	}
