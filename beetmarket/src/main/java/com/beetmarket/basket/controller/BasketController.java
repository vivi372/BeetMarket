...
public class BasketController {
	...
	@GetMapping("/list.do")
	public String basketList(Model model,RedirectAttributes rttr) {
	...
	public String writeForm(Model model) {
		...
		vo.setGoodsStatusName("판매중");
		vo.setGoodsPrice(10000L);
		model.addAttribute("vo", vo);
		return "basket/write";
	}
	
	@PostMapping("/write.do")
	public String basketWrite(HttpServletRequest request,Long goodsNo
			,Long[] optNo,Long[] amount, RedirectAttributes rttr) throws Exception {		
		...
		return "redirect:/goods/shopView.do?goodsNo="+goodsNo+"&"+pageObject.getPageQuery();
		
	}
	
	@PostMapping("/update.do")
	public String basketUpdate(long basketNo,long[] optNo,long[] amount,RedirectAttributes rttr) {
